...
A brand-new account whose only article is about its author's own product
gets read as an ad. This one mentions FailEcho in two sentences at the very
end and is otherwise just four things that are true. It builds the audience
the main post needs -- people who run agents -- and it means the profile is
not empty when the main post lands.
